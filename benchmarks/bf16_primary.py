...
FIXTURE_FILES = tuple("benchmarks/" + name for name in (
    ...
    "bf16_device.py", "bf16_kernel_export.py", "bf16_primary.py", "bf16_residency_check.py", "bf16_comparison.py", "gluon_compat.py",
)) + ("validation/oracle.py", "validation/softmax_checks.py", "validation/layout_checks.py")
